...
# B → A
data modify block -29999983 56 -29999983 Items[0].tag.Storage append from block -29999983 56 -29999982 Items[0].tag.Storage[{Slot:0b}]
scoreboard players add swap_count IO_MS_STATUS 1

function orion.io:slots/slot0/get_inventory_item_key
